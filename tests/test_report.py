...
class TestDynamicCIs:
    """Verifies that the Wilson Score Interval is applied correctly."""

    def test_calculate_binary_ci_wilson(self) -> None:
        ...
        # Wilson's CI for p=0.5, n=100 is approx (0.404, 0.596)
        assert round(ci[0], 3) == 0.404
        assert round(ci[1], 3) == 0.596

    def test_calculate_binary_ci_extreme_p(self) -> None:
        """Wilson Score works properly even for extreme p values."""
    ...
    def test_calculate_binary_ci_small_n(self) -> None:
        """Wilson Score properly widens intervals for small n."""
